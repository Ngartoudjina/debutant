    ...
    <div className="relative min-h-screen overflow-hidden bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-blue-900 via-gray-900 to-purple-900">
      ...
      <div className="relative container mx-auto px-6 py-24">
        ...
        >
          ...
          <motion.div style={{ y: textY }} className="flex flex-col gap-y-8 lg:w-1/2">
            {/* Premium Badge */}
            <motion.div
            ...
            >
              ...
              <span className="text-sm font-medium text-gray-200">Service Premium de Livraison</span>
            </motion.div>

            {/* Enhanced Title */}
            <motion.h1 variants={itemVariants} className="text-5xl md:text-6xl font-bold leading-tight tracking-tight">
              <motion.span
            ...
            {/* Description */}
            <motion.p variants={itemVariants} className="text-xl text-gray-300 leading-relaxed max-w-xl">
              Confiez-nous vos colis et profitez d'une livraison express, fiable et à votre porte. Notre engagement: votre satisfaction.
            </motion.p>
            ...
            {/* Enhanced Statistics */}
            <motion.div variants={itemVariants} className="grid grid-cols-1 sm:grid-cols-3 gap-8 mt-12 bg-white/5 backdrop-blur-lg rounded-2xl p-8 border border-white/10">
              {stats.map((stat, index) => (
                ...
                >
                  ...
                  <motion.div
                    ...
                    style={{
                      background: `linear-gradient(135deg, ${
                        stat.gradientId === "blueGradient"
                          ? "#60a5fa, #22d3ee"
                          : stat.gradientId === "greenGradient"
                          ? "#4ade80, #10b981"
                          : "#a855f7, #ec4899"
                      })`,
                  ...
                  {/* Description */}
                  <div className="text-sm text-gray-300 opacity-80">{stat.description}</div>
            ...
            <motion.div variants={itemVariants} className="text-center mt-8">
              ...
              >
                Plus de <span className="text-blue-400 font-semibold">10 000</span> clients nous font
                confiance • <span className="text-green-400 font-semibold">98%</span> de satisfaction
                client • Support <span className="text-purple-400 font-semibold">24h/24 et 7j/7</span>
              </motion.p>
            </motion.div>
          </motion.div>
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-300 text-sm mt-1">Assistance immédiate</p>
                      </div>
                    </div>
                  </motion.div>
                )}
