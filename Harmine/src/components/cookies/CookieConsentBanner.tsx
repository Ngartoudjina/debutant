  ...
  return (
    <AnimatePresence>
      {showBanner && (
        ...
        >
          <div className="bg-white dark:bg-gradient-to-r dark:from-gray-900 dark:via-slate-900 dark:to-blue-950 border border-gray-200 dark:border-transparent shadow-xl p-6 mx-4 mb-4 rounded-2xl">
            <div className="max-w-7xl mx-auto">
              <div className="flex items-start mb-4">
                <Cookie className="w-6 h-6 text-blue-700 dark:text-blue-400 mr-3 flex-shrink-0" />
                <div className="flex-grow">
                  <h2 className="text-xl font-bold mb-2 text-transparent bg-clip-text bg-gradient-to-r from-blue-700 to-purple-700 dark:from-blue-400 dark:to-purple-600">
                ...
                <button
                  ...
                  className="text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition ml-4"
                >
                  <X className="w-5 h-5" />
                </button>
              </div>
                ...
                {showDetails && (
                  ...
                  >
                    {Object.entries(cookieSettings).map(([key, value]) => (
                      <div key={key} className="flex items-center justify-between py-2 border-b border-gray-200 dark:border-white/10 last:border-0">
                        <div className="flex items-center">
                          <Shield className="w-4 h-4 text-blue-700 dark:text-blue-400 mr-2" />
                          <div className="flex flex-col">
                            <span className="text-sm text-gray-900 dark:text-gray-300 capitalize">{key}</span>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-end space-y-2 sm:space-y-0 sm:space-x-4">
                <button
                  ...
                  className="text-sm text-blue-700 dark:text-blue-400 hover:text-blue-900 dark:hover:text-blue-300 transition underline"
                >
                ...
                <div className="flex space-x-4">
                  <button
                    ...
                    className="px-4 py-2 bg-gray-100 hover:bg-gray-200 dark:bg-white/10 dark:hover:bg-white/20 text-gray-900 dark:text-white rounded-lg transition text-sm"
                  >
                    Refuser tout
                  </button>
                  {showDetails ? (
